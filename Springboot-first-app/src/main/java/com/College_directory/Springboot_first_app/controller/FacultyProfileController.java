...
public class FacultyProfileController {
    ...
    public ResponseEntity<FacultyProfile> createFacultyProfile(@PathVariable Long userId, @RequestBody FacultyProfileDTO facultyProfileDTO) {
        FacultyProfile facultyProfile = facultyProfileService.createFacultyProfile(userId, facultyProfileDTO);
